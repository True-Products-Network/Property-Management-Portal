    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[var(--secondary-text)] mt-1">Manage individual units and apartments</p>
        </div>
      </div>
      <div className="flex flex-col items-center justify-center py-20 text-center">
        ...
        <h2 className="text-lg font-medium text-[var(--main-text)]">Units</h2>
        <p className="text-[var(--secondary-text)] mt-2 max-w-md">
          This page is under construction. Unit management features coming soon.
        </p>
      </div>
    </div>
  );
