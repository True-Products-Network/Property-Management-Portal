        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              ...
              >
                <option value="admin">Admin - Full access to tenant</option>
                <option value="manager">Manager - Can manage properties and users</option>
                <option value="staff">Staff - Standard user access</option>
                <option value="board_member">Board Member - Read-only with voting</option>
