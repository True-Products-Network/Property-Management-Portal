...
-- ============================================
-- VENDORS (Defined before contact_roles)
-- ============================================
...
-- ============================================
-- ROW LEVEL SECURITY (Basic - to be expanded)
-- ============================================
...
-- Simple RLS policies (temporary - will be refined)
CREATE POLICY "Enable read access for authenticated users" ON associations
...
CREATE POLICY "Enable read access for authenticated users" ON compliance_matters
    FOR SELECT USING (auth.role() = 'authenticated');

CREATE POLICY "Enable read access for authenticated users" ON approvals
    FOR SELECT USING (auth.role() = 'authenticated');

CREATE POLICY "Enable read access for authenticated users" ON communications
    FOR SELECT USING (auth.role() = 'authenticated');
