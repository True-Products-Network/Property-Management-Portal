...
-- This makes dropdowns admin-configurable via the Dropdown Settings page

-- Vendor Categories
INSERT INTO dropdown_settings (record_type, field_name, option_value, option_label, sort_order, is_active)
VALUES
...
ON CONFLICT (record_type, field_name, option_value) DO NOTHING;
