-- Create functions to execute tenant seed SQL files
-- These functions are called by the API to run seed SQL

-- Function to execute SQL with tenant_id
...
-- Function to execute SQL with business_id
...
GRANT EXECUTE ON FUNCTION exec_sql_with_tenant(TEXT, UUID) TO service_role;
GRANT EXECUTE ON FUNCTION exec_sql_with_business(TEXT, UUID) TO service_role;
