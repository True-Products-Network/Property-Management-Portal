-- Fix check_entity_limit function
-- Drops the broken version and recreates the correct one

-- Drop the broken function that references plan_entitlements
...
-- Create the correct function from the migration
...
BEGIN
  ...
  -- Get limit from tenant_entity_limits
